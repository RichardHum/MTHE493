...
////////////////////////////////////////////////////////////////////////////////
    ...
    gaussian(filter[5],1,filtRows[5],filtCols[5]);
    ...
    for(i=0;i<noFilts;i++)
     ...
     float lambdaTemp[8][6] = {{0.0440000000000000,0.438800000000000,-0.372400000000000,0.398400000000000,-0.422000000000000,0.000400000000000000},
