...
////////////////////////////////////////////////////////////////////////////////
    ...
    for (i=0; i<noFilts; i++)
        normObsHistogram[i] = malloc(256 * sizeof(*normObsHistogram[i]));
    ...
    for (i=0; i<noFilts; i++)
        normSynthHistogram[i] = malloc(256 * sizeof(*normSynthHistogram[i]));
    ...
    } while ((diff > min || loopNo<=1000) && loopNo<5);
